    ...
    <form id="form1" runat="server">
        ...
        <div class="orc-container">
            ...
            <div class="form_orcamento" autocomplete="off">
                ...
                <div class="dpProd">
                    <label id="lblProd">Selecione o produto:</label>
                ...
                <div class="btnTable">
                    <button onclick="addRow();" id="btnAdd">+</button>
                ...
                <div class="campos_orcamento_servicos" id="descricao_orcamento_servico">
                    <table>
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <input class="inpt_orc" id="cod_input" type="text" /><asp:Label runat="server" ID="lblIDServico"></asp:Label></td>
                                <td>
                                    <input class="inpt_orc" id="desc_input" type="text" /><asp:DropDownList ID="ddlServico" runat="server" OnSelectedIndexChanged="ddlServico_SelectedIndexChanged" AutoPostBack="True"></asp:DropDownList></td>
                                <td>
                                    <input class="inpt_orc" id="subt_input" type="text" /><asp:Label runat="server" ID="lblSubtSv"></asp:Label></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
        ...
        <footer>
            ...
            <script src="LinhaTabela.js"></script>
        </footer>
    </form>
</body>
</html>
